...
So, don't run this part in case of arising issues with {OpenStreetMap}, but jump on the next one.
...
frogs_location_tm <- tibble(ReportedDay = oregonfrogs_raw$Ordinal,
...
# make a grid
frogs_coord_freq <- tibble(oregonfrogs_raw$UTME_83, oregonfrogs_raw$UTMN_83,
                      oregonfrogs_raw$Frequency)
...
#| eval: false
#| include: true
raster::plot(predictions,xlim=c(-125,-100),ylim=c(35,55),axes=T)
```
